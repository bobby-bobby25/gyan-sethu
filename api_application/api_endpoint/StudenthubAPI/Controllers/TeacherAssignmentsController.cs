    ...
    public class TeacherAssignmentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] TeacherAssignmentBO assignment)
        {
            ...
            await _context.Database.ExecuteSqlRawAsync(
                "EXEC sp_CreateTeacherAssignment @TeacherID, @AcademicYearID, @ClusterID, @ProgramID, @LearningCentreID, @Role, @IsActive, @Output OUTPUT",
                ...
                new SqlParameter("@LearningCentreID", assignment.learning_centre_id),
        ...
        public async Task<IActionResult> Update(int id, [FromBody] TeacherAssignmentBO assignment)
        {
            var output = new SqlParameter("@Output", SqlDbType.NVarChar, 50) { Direction = ParameterDirection.Output };
            await _context.Database.ExecuteSqlRawAsync(
                "EXEC sp_UpdateTeacherAssignment @TeacherAssignmentID, @AcademicYearID, @ClusterID, @ProgramID, @LearningCentreID, @Role, @IsActive, @Output OUTPUT",
