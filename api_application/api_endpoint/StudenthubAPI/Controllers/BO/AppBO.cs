...
namespace StudenthubAPI.BO
{
    ...
    public class StudentBO
    {
        ...
        [JsonPropertyName("sibling_student_code")]
    ...
    public class CreateStudentBO
    {
        ...
        [JsonPropertyName("sibling_student_code")]
        public string? SiblingStudentCode { get; set; }
    }
    ...
    public class UpdateActiveStatusBO
    {
        [JsonPropertyName("is_active")]
        public bool IsActive { get; set; }
    }
    ...
    public class StudentAcademicRecordBO
    {
        ...
        [JsonPropertyName("learning_centre_id")]
        public int LearningCentreId { get; set; }
    ...
    public class TeacherBO
    {
        ...
        [JsonPropertyName("learning_centre")]
        public string LearningCentre { get; set; }
        ...
        [JsonPropertyName("is_ex_student")]
        public bool IsExStudent { get; set; }
    }
    ...
    public class ClusterStatsBO
    {
        ...
        [JsonPropertyName("learning_centre_count")]
        public int? LearningCentreCount { get; set; }
    ...
    public class AttendanceRecordBO
    {
        ...
        [JsonPropertyName("learning_centre_name")]
    ...
    public class AttendanceReportBO
    {
        ...
        [JsonPropertyName("learning_centre_name")]
        public string LearningCentreName { get; set; } = string.Empty;
    ...
    public class TeacherAssignmentBO
    {
        ...
        [JsonPropertyName("learning_centre_id")]
        public int learning_centre_id { get; set; }
    ...
    public class TeacherSubjectInput
    {
        public string? name { get; set; }
        public string? code { get; set; }
        public string? description { get; set; }
    ...
    public class StudentMediumInput
    {
        public string? name { get; set; }
        public string? code { get; set; }
    }
    ...
    // DASHBOARD DATA BOs
    // =============================================
    public class LearningCentreProgramCombinationsBO
    {
        [JsonPropertyName("learning_centre_id")]
        public int LearningCentreId { get; set; }
        ...
        [JsonPropertyName("learning_centre_city")]
        public string LearningCentreCity { get; set; }
    ...
    public class LearningCenterStatsBO
    {
        [JsonPropertyName("id")]
        public int Id { get; set; }
    ...
    public class CreateLearningCentreBO
    {
        public int cluster_id { get; set; }
        public string name { get; set; }
        public string address { get; set; }
    ...
    public class UpdateLearningCentreBO
    {
        public string name { get; set; }
        public string address { get; set; }
        public string city { get; set; }
