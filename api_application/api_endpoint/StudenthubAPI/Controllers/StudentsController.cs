...
namespace StudenthubAPI.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateStudent([FromBody] CreateStudentBO createStudentBO)
        {
            try
            {
                ...
                await _dataContext.Database.ExecuteSqlRawAsync(
                    ...
                    "@Address, @City, @State, @CasteID, @SiblingStudentCode, @StudentID OUTPUT, @Output OUTPUT",
                    ...
                    new SqlParameter("@SiblingStudentCode", (object)createStudentBO.SiblingStudentCode ?? DBNull.Value),
                    studentIdParameter,
                    outputParameter);
        ...
        public async Task<IActionResult> ActiveStatus(int id, [FromBody] UpdateActiveStatusBO updateActiveStatusBO)
        {
            try
            {
                var outputParameter = new SqlParameter("@Output", SqlDbType.NVarChar, 50)
                ...
                await _dataContext.Database.ExecuteSqlRawAsync(
                    "EXEC spUpdateStudentActiveStatus @StudentID, @IsActive, @Output OUTPUT",
                    new SqlParameter("@StudentID", id),
                    new SqlParameter("@IsActive", updateActiveStatusBO.IsActive),
                    outputParameter);
                ...
                if (result == "Success")
                {
                    return Ok(new { message = "Student active status changed successfully" });
                }

                return BadRequest(new { message = "Failed to change student active status" });
            }
            catch (Exception ex)
            {
                return StatusCode(500, new { message = "An error occurred while change student active status", error = ex.Message });
            }
        }
        #endregion
        ...
        public async Task<IActionResult> UpdateStudent(int id, [FromBody] UpdateStudentBO updateStudentBO)
        {
            try
            {
                ...
                await _dataContext.Database.ExecuteSqlRawAsync(
                    ...
                    "@Address, @City, @State, @CasteID, @SiblingStudentCode, @Output OUTPUT",
                    new SqlParameter("@StudentID", id),
                    ...
                    new SqlParameter("@SiblingStudentCode", (object)updateStudentBO.SiblingStudentCode ?? DBNull.Value),
                    outputParameter);
        ...
        public async Task<IActionResult> CreateAcademicRecord([FromBody] CreateAcademicRecordBO model)
        {
            try
            {
                ...
                await _dataContext.Database.ExecuteSqlRawAsync(
                    "EXEC sp_InsertStudentAcademicRecord @StudentID, @AcademicYearID, @ClusterID, @ProgramID, @LearningCentreID, @SchoolName, @ClassGrade, @AttendancePercentage, @ResultPercentage, @YearlyFees, @Remarks, @SchoolTypeID, @MediumID, @IsActive, @Output OUTPUT",
                    ...
                    new SqlParameter("@LearningCentreID", model.LearningCentreID),
                    ...
                    new SqlParameter("@SchoolTypeID", (object)model.SchoolTypeID ?? DBNull.Value),
                    new SqlParameter("@MediumID", (object)model.MediumID ?? DBNull.Value),
        ...
        public async Task<IActionResult> UpdateAcademicRecord(int id, [FromBody] UpdateAcademicRecordBO model)
        {
            try
            {
                ...
                await _dataContext.Database.ExecuteSqlRawAsync(
                    "EXEC sp_UpdateStudentAcademicRecord @StudentAcademicRecordID, @StudentID, @AcademicYearID, @ClusterID, @ProgramID, @LearningCentreID, @SchoolName, @ClassGrade, @AttendancePercentage, @ResultPercentage, @YearlyFees, @Remarks, @SchoolTypeID, @MediumID, @IsActive, @Output OUTPUT",
        ...
        public async Task<IActionResult> SearchStudents([FromQuery] string name)
        {
            try
            {
                ...
                var results = await _dataContext.StudentSearch
                    .FromSqlRaw(
                        "EXEC spSearchStudentsByCode @StudentName",
